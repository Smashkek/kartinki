...
class Mapmanager:
    ...
    def __init__(self):
        ...
        self.textures = [
            "textures/pngtree-powder-smoke-colorful-background-image_2164096.jpg",
            "textures/images (2).jfif",
            "textures/images (3).jfif",
            "textures/images (4).jfif",
            "textures/images (5).jfif",
        ]
